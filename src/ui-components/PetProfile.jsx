...
export default function PetProfile(props) {
  ...
  const buttonThreeEightFiveZeroFourThreeFourOneOnClick =
  ...
  return (
    <Flex
      ...
      backgroundColor="rgba(174,186,214,1)"
    ...
    >
      <Button
        ...
        children="Delete"
        onClick={() => {
          buttonThreeEightFiveZeroFourThreeFourOneOnClick();
        }}
        {...getOverrideProps(overrides, "Button38504341")}
      ></Button>
      <Image
        width="160px"
        height="160px"
      ...
      <Button
        ...
        variation="primary"
        children="Update"
        {...getOverrideProps(overrides, "Button38504274")}
      ></Button>
    </Flex>
  );
}
